...
HD_PWD='E:/ZYNQ/MT/axis_mt19937/axis_mt19937.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axis_mt19937.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axis_mt19937.tcl
