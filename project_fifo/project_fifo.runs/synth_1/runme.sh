...
HD_PWD='E:/ZYNQ/project_fifo/project_fifo/project_fifo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log use_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source use_fifo.tcl
